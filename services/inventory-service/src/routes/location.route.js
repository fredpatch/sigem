...
// authenticate,
// canWrite,
validateBody(CreateSchema), audit("create", "Location"), LocationController.create);
locationRoutes.patch("/:id", 
// authenticate,
// canWrite,
validateBody(UpdateSchema), audit("update", "Location"), LocationController.update);
locationRoutes.delete("/:id/delete", 
// authenticate,
// canWrite,
audit("delete", "Location"), LocationController.remove);
