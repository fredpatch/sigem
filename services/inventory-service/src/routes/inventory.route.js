...
const canWrite = authorizedRoles("MG_COS", "MG_COB", "MG_AGT", "SUPER_ADMIN", "ADMIN");
...
categoryRoutes.post("/", authenticate, canWrite, validateBody(CreateSchema), audit("create", "Category"), CategoryController.create);
categoryRoutes.patch("/:id", authenticate, canWrite, validateBody(UpdateSchema), audit("update", "Category"), CategoryController.update);
categoryRoutes.delete("/:id/delete", authenticate, canWrite, audit("delete", "Category"), CategoryController.remove);
