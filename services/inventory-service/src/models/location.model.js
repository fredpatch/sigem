...
export var LocationLevel;
(function (LocationLevel) {
    LocationLevel["LOCALISATION"] = "LOCALISATION";
    LocationLevel["BATIMENT"] = "BATIMENT";
    LocationLevel["DIRECTION"] = "DIRECTION";
    LocationLevel["BUREAU"] = "BUREAU";
...
LocationSchema.index({ localisation: 1, batiment: 1, direction: 1, bureau: 1 }, { unique: true });
// ----------------- helpers -----------------
const upper = (s) => (s ?? "").toUpperCase().trim();
// "Agence Comptable" -> "AC", "Pool Charge d'étude" -> "PCE", "DG" -> "DG"
function shortFromLabel(label, maxLen = 3) {
