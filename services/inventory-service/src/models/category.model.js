...
export var CategoryFamily;
(function (CategoryFamily) {
    CategoryFamily["EQUIPEMENT"] = "EQUIPEMENT";
    CategoryFamily["INFORMATIQUE"] = "INFORMATIQUE";
    CategoryFamily["MOBILIER"] = "MOBILIER";
...
const famInitial = (f) => (f ? f.charAt(0) : ""); // E|I|M
